...
def static_page(article):
    ...
    if isinstance(title_lines, list) and len(title_lines) >= 2:
        article_title_html = "".join(
            f'<span class="{"article-title-primary" if index < 2 else "article-title-subline"}">{html.escape(line)}</span>'
...
<head>
  ...
  <link rel="stylesheet" href="/css/gallery-transition.css?v=gallery36" />
  <link rel="stylesheet" href="/css/article-caption-gap.css?v=caption43" />
...
<body>
  ...
  <script src="/data/articles.js?v=7"></script><script src="/articles/{slug}.js?v={int(article['version'])}"></script><script src="/js/static-article.js?v=19"></script><script src="/js/article-lightbox.js?v=3"></script>
</body>
</html>
'''
