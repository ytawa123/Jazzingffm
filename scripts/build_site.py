...
<body>
  ...
  <script src="/data/articles.js?v=4"></script><script src="/articles/{slug}.js?v={int(article['version'])}"></script><script src="/js/static-article.js?v=19"></script><script src="/js/article-lightbox.js?v=3"></script>
</body>
</html>
'''
